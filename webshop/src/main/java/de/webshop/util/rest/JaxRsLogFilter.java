...
//FIXME JAX-RS Problem: "Fehlende Implementierung v. ExceptionMapper, ContextResolver oder anderen? 
//		Implementierung schlägt fehl. Lösungen?
@Provider
public class JaxRsLogFilter implements ContainerRequestFilter, ContainerResponseFilter, ExceptionMapper {
